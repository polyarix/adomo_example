...
@section('header')
    ...
    <script>
        window.statusClasses = @json(\App\Entity\User\AdminUser::getStatusClasses());
        window.documentsClass = '{{ \App\Entity\User\AdminUser::DOCUMENTS_CLASS }}'
    </script>
...
@section('after_scripts')
	@include('admin.user.user._datatables_logic')
