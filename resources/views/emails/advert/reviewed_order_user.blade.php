...
@section('title', 'Adomo - отзыв в работе с вами.')
    ...
    <table class="body-table" cellpadding="0" cellspacing="0" style="width:100%;font-family:'Open Sans', sans-serif;background-color:#F2F2F2;padding-top:17px;padding-bottom:17px;padding-right:30px;padding-left:30px;">
        <tbody><tr>
            <td style="padding-bottom:20px;">
                <h1 style="margin-top:0;margin-bottom:0;margin-right:0;margin-left:0;font-size:24px;font-weight:normal;color:#000000;">Задача завершена!</h1>
            </td>
        </tr>
        <tr>
            <td style="padding-bottom:20px;">
        ...
        <tr>
            <td style="padding-bottom:20px;">
                <p style="font-style:normal;font-weight:normal;font-size:14px;line-height:19px;color:#000000;margin-top:5px;margin-bottom:5px;margin-right:0;margin-left:0;">
                    {{ $user->getType() }} <a href="{{ route('user.details', $user) }}" style="text-decoration:none;color:#0277BD;word-break:break-all;">{{ $user->first_name }} {{ $user->last_name }}</a>
                    подтвердил завершение задачи и оставил отзыв о работе с вами. Посмотреть его можно <a href="{{ route('cabinet.reviews') }}" style="text-decoration:none;color:#0277BD;word-break:break-all;">здесь.</a>
                </p>
            </td>
        </tr>
        </tbody></table>
